...
##############################################################################################
 $TenantID = "0d02d0b5-802d-427e-abc8-5166348b7f1ff"
...
######################################################################################################################
# Upload SecureString to KeyVault                                                                                    #
######################################################################################################################
$securevalue = ConvertTo-SecureString "Dell9000!" -AsPlainText -Force
$secret =  Set-AzureKeyVaultSecret -VaultName "pwdbios" -Name $DeviceName -SecretValue $securevalue
...
$secret = (Get-AzKeyVaultSecret -vaultName "PWDBIOS" -name "1X752J3") | select *
